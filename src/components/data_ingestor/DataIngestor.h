...
class DataIngestor {
  ...
  public:
    ...
    void printTelemetry(const TelemetryBatch &batch, int limit = 10) const;
    ...
    virtual void parseTelemetry(const std::string &filename) = 0;
  ...
  protected:
    ...
    int parsePriority(std::string_view priority_str) const;
