...
TEST_CASE("evaluate returns true when value is above threshold", "[SimpleRule][evaluate]")
{
...
TEST_CASE("evaluate returns false when value is below threshold", "[SimpleRule][evaluate]")
{
    SimpleRule rule = makeRule();
...
TEST_CASE("evaluate returns false when value equals threshold (strict >)", "[SimpleRule][evaluate]")
{
    SimpleRule rule = makeRule();
...
TEST_CASE("evaluate returns nullopt for mismatched sensor id", "[SimpleRule][evaluate][nullopt]")
{
    SimpleRule rule = makeRule();
...
TEST_CASE("evaluate returns nullopt for non-numeric value", "[SimpleRule][evaluate][nullopt]")
{
    SimpleRule rule = makeRule();
...
TEST_CASE("evaluate returns nullopt for missing delimiter", "[SimpleRule][evaluate][nullopt]")
{
    SimpleRule rule = makeRule();
...
TEST_CASE("evaluate returns nullopt for extra fields", "[SimpleRule][evaluate][nullopt]")
{
    SimpleRule rule = makeRule();
...
TEST_CASE("evaluate returns nullopt for empty value field", "[SimpleRule][evaluate][nullopt]")
{
    SimpleRule rule = makeRule();
